...
exports.productApplication = void 0;
const db_1 = require("../db");
const post_1 = require("./post");
function productApplication(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        let current = req.params.current;
        let currentId = Number(current);
        let explain = "", postID;
        const explainlist = yield db_1.Dbs.content.getProductApplication(currentId);
...
;
//# sourceMappingURL=productApplication.js.map